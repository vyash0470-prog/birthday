...
function MessageCard({ isActive }) {
  ...
  const message = `My Babyyy❤️,

Happiest Birthday! Chamar Boiiiii
HAHAHAHAHAHAHHAHAH!!! Ok fun on the other side but Happy Birthday to my baby with all my love, You've me with you always for the whole life now and we are locked with each other for the rest of our life and ykw JAA BHI NHI SKTE IFYKYK HAHAHA🥰 but ILOVEYOU AND ENJOY YOUR DAY WITH LOTS OF FUN 
