    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Nannu</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Nannu's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Happy Birthday to the Prettiest Baby😘💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Yash💖</h2>
          <p className="final-subtitle">Enjoy your Day with Super Fun✨ and ILOVEYOUUUU💗❤️💌🎀♾️</p>
        </section>
      </div>
